...
<template>
    <div>
      ...
      <!-- ====== СПИСОК ПАКОВ ====== -->
      <List :items="packs" header="Мои крутые паки" @edit="handleEdit" @play="handlePlay">
        <template #header>
          <div class="flex items-center gap-2">
            <h2 class="text-lg font-bold">Пользовательские паки</h2>
            <button class="btn btn-square btn-ghost" @click="openCreatePackModal" aria-label="Создать пак">
      ...
      <dialog ref="createPackDialog" class="modal">
        <div class="modal-box">
          <button class="btn btn-sm btn-circle btn-ghost absolute right-2 top-2"
                  @click="createPackDialog.close()">✕</button>
